...
class AdListResponseModel {
  ...
  factory AdListResponseModel.fromJson(String str) =>
      AdListResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AdListResponseModel.fromMap(Map<String, dynamic> json) =>
      AdListResponseModel(
        currentPage: json["current_page"] ?? 0,
        adsList: List<Ad>.from(json["data"].map((x) => Ad.fromJson(x))),
...
class CustomField {
  ...
  factory CustomField.fromJson(String str) =>
      CustomField.fromMap(json.decode(str));
