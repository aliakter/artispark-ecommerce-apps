...
class Plan {
  ...
  factory Plan.fromJson(Map<String, dynamic> json) => Plan(
        adLimit: json["ad_limit"] is String ? int.parse(json["ad_limit"]) : json["ad_limit"] ?? "",
        featuredLimit: json["featured_limit"] is String ? int.parse(json["featured_limit"]) : json["featured_limit"] ?? "",
        badge: json["badge"],
        eventLimit: json["event_limit"]  is String ? int.parse(json["event_limit"]) : json["event_limit"] ?? "",
        businessDirectoryLimit: json["business_directory_limit"]  is String ? int.parse(json["business_directory_limit"]) : json["business_directory_limit"] ?? "",
      );
