            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  style: OutlinedButton.styleFrom(foregroundColor: primaryColor,shadowColor: ashColor,side: const BorderSide(color: primaryColor,strokeAlign: BorderSide.strokeAlignInside),shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4))),
                  onPressed: (){
