...
import 'package:artispark/apps/views/home/models/service_model.dart';
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField(
          ...
          items:
        widget.controller.homeController.homeModel?.designations.map<DropdownMenuItem<Brand>>((e) {
          ...
          onChanged: (value) {
            Future.delayed(const Duration(milliseconds: 300)).then((value2) {
              widget.controller.selectedDesignation = value?.name.toString()??"";
              },
            );
          },
        ),
          ...
          children: [
            SizedBox(
              ...
              child: Obx(() => Checkbox(
                ...
                onChanged: (value){
                  widget.controller.receiveIsEmail.value = !widget.controller.receiveIsEmail.value;
          ...
          children: [
            SizedBox(
              ...
              child: Obx(() => Checkbox(
                ...
                onChanged: (value){
                  widget.controller.receiveIsPhone.value = !widget.controller.receiveIsPhone.value;
                },activeColor: const Color(0xFF0b5ed7))),
            ),
            const SizedBox(width: 0,),
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: widget.controller.logoImage == null ? const SizedBox() : Center(
                child: SizedBox(
                  height: 70,
                  width: 70,
                  child: Image(
                    // image: FileImage(File(controller.images2![index].path))
                    image: FileImage(File(widget.controller.logoImage!.path)),
                    fit: BoxFit.contain,
                  ),
                ),
              ),
