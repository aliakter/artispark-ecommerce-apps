                ...
                return GestureDetector(
                  onTap: () {
                    if (widget.controller.fuelTypes
                      ...
                      widget.controller.fuelTypes.remove(fuelTypeList[index]["name"].toString().trim());
                    } else {
                      widget.controller.fuelTypes.add(fuelTypeList[index]["name"].toString().trim());
                    }
                  ...
                  child: Row(
                    ...
                    children: [
                      Checkbox(
                          ...
                          value: widget.controller.fuelTypes
                              .any((element) => element == fuelTypeList[index]["name"]),
                          onChanged: (value) {
                            if (value!) {
                              widget.controller.fuelTypes.add(fuelTypeList[index]["name"].toString().trim());
                      ...
                      Text(index != 2 && index != 6 ? fuelTypeList[index]['name']![0].toString().toUpperCase().trim() + fuelTypeList[index]['name'].toString().substring(1).trim() :  fuelTypeList[index]['name'].toString().toUpperCase().trim()),
                    ],
                  ),
                );
              })
